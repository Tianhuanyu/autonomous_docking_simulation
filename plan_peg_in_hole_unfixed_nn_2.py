...
from behaviour_cloning_2 import load_model, torch
...
while pb.isConnected():
    ...
    state_np = np.concatenate((q, box_base_position, box_base_orientation, f_ext))
...
filename = f'f_ext_nn_2_{success_msg}_{stamp}.csv'
