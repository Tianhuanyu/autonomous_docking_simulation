...
exec_plan(pre_insertion_plan, pre_insertion_dur, time_factor=0.001)
...
while pb.isConnected():
    ...
    q = controller(q, box_base_position, goal_z)
    robot.cmd(q)
...
filename = f'f_ext_v2_{success_msg}_{stamp}.csv'
