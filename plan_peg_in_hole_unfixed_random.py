...
for _ in range(N):
    ...
    wt1 = np.random.uniform(*bounds['W_TASK_1'])
    wt2 = np.random.uniform(*bounds['W_TASK_2'])
    wt3 = np.random.uniform(*bounds['W_TASK_3'])
    wt4 = np.random.uniform(*bounds['W_TASK_4'])
    wt5 = np.random.uniform(*bounds['W_TASK_5'])
